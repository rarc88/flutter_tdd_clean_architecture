  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test(
      ...
      () async {
        ...
        // assert later
        await expectLater(bloc.state, Empty());
        expectLater(
          bloc.stream,
          emits(const Error(message: invalidInputFailureMessage)),
        );
        // act
        bloc.add(const GetTriviaForConcreteNumber(tNumberString));
      },
    ...
    test(
      ...
      () async {
        ...
        final expected = [
          emits(Loading()),
          emits(const Loaded(trivia: tNumberTrivia)),
        ];
    ...
    test(
      ...
      () async {
        ...
        final expected = [
          emits(Loading()),
          emits(const Error(message: serverFailureMessage)),
        ];
        expectLater(bloc.stream, emitsInOrder(expected));
        // act
        bloc.add(const GetTriviaForConcreteNumber(tNumberString));
  ...
  group('GetTriviaForRandomNumber', () {
    ...
    test(
      ...
      () async {
        ...
        final expected = [
          emits(Loading()),
          emits(const Error(message: cacheFailureMessage)),
        ];
        expectLater(bloc.stream, emitsInOrder(expected));
        // act
        bloc.add(GetTriviaForRandomNumber());
